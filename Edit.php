...
try{
    ...
    $query = "SELECT FIRST_NAME, LAST_NAME, EMAIL, ADDRESS FROM customers WHERE CUSTOMER_ID = ? LIMIT 0,1";
...
if(empty($errors)) {
    ...
    // inset query
    $query = "UPDATE customers SET FIRST_NAME = ?, LAST_NAME = ?, EMAIL = ?, ADDRESS = ? WHERE CUSTOMER_ID =?";
        ...
        <div class="card-body">
          ...
          <form action="#" method="POST">
            ...
            <div class="form-group mt-2">
                ...
                <input type="text" class="form-control" name="FIRST_NAME" maxlength="100" value="<?php echo $editFirstName;?>">
            ...
            <div class="form-group mt-2">
                ...
                <input type="text" class="form-control" name="LAST_NAME" maxlength="100" value="<?php echo $editLastName;?>">
            ...
            <!-- Email -->
             <div class="form-group mt-2">
                ...
                <input type="email" class="form-control" name="EMAIL" maxlength="255" value="<?php echo $editEmail;?>">
            ...
            <div class="form-group mt-2">
                ...
                <input type="text" class="form-control" name="ADDRESS" maxlength="255" value="<?php echo $editAddress;?>">
